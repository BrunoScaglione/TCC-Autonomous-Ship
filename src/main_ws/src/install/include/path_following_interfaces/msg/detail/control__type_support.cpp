...
{
  new (message_memory) path_following_interfaces::msg::Control(_init);
}

void Control_fini_function(void * message_memory)
{
  auto typed_message = static_cast<path_following_interfaces::msg::Control *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Control_message_member_array[2] = {
  {
    ...
    offsetof(path_following_interfaces::msg::Control, desired_value),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(path_following_interfaces::msg::Control, distance_waypoints),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Control_message_members = {
  ...
  2,  // number of fields
  sizeof(path_following_interfaces::msg::Control),
...
{
  return &::path_following_interfaces::msg::rosidl_typesupport_introspection_cpp::Control_message_type_support_handle;
}
