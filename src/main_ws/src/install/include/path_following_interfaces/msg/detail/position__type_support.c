  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  path_following_interfaces__msg__Position__init(message_memory);
}

void Position__rosidl_typesupport_introspection_c__Position_fini_function(void * message_memory)
{
  path_following_interfaces__msg__Position__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Position__rosidl_typesupport_introspection_c__Position_message_member_array[3] = {
  {
    ...
    offsetof(path_following_interfaces__msg__Position, x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(path_following_interfaces__msg__Position, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(path_following_interfaces__msg__Position, theta),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Position__rosidl_typesupport_introspection_c__Position_message_members = {
  ...
  3,  // number of fields
  sizeof(path_following_interfaces__msg__Position),
