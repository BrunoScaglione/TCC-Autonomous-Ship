...
#ifndef PATH_FOLLOWING_INTERFACES__MSG__DETAIL__STATE__TYPE_SUPPORT_H_
#define PATH_FOLLOWING_INTERFACES__MSG__DETAIL__STATE__TYPE_SUPPORT_H_
...
#endif  // PATH_FOLLOWING_INTERFACES__MSG__DETAIL__STATE__TYPE_SUPPORT_H_
