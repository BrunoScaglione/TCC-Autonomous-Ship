...
class Metaclass_Waypoints(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'path_following_interfaces.srv.Waypoints')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from path_following_interfaces.srv import _waypoints
...
class Waypoints(metaclass=Metaclass_Waypoints):
    from path_following_interfaces.srv._waypoints import Waypoints_Request as Request
    from path_following_interfaces.srv._waypoints import Waypoints_Response as Response
