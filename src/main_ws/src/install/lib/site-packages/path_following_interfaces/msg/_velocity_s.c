...
bool path_following_interfaces__msg__velocity__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("path_following_interfaces.msg._velocity.Velocity", full_classname_dest, 48) == 0);
  }
  path_following_interfaces__msg__Velocity * ros_message = _ros_message;
  {  // u
...
PyObject * path_following_interfaces__msg__velocity__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("path_following_interfaces.msg._velocity");
