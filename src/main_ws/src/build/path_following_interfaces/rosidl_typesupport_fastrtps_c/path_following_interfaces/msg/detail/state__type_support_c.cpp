...
#include "path_following_interfaces/msg/detail/state__rosidl_typesupport_fastrtps_c.h"
...
#include "path_following_interfaces/msg/detail/position__functions.h"  // position
#include "path_following_interfaces/msg/detail/velocity__functions.h"  // velocity
...
using _State__ros_msg_type = path_following_interfaces__msg__State;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: position
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, path_following_interfaces, msg, Position
      )()->data);
  ...
  // Field name: velocity
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, path_following_interfaces, msg, Velocity
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_path_following_interfaces__msg__Position(
    &(ros_message->position), current_alignment);
  // field.name velocity

  current_alignment += get_serialized_size_path_following_interfaces__msg__Velocity(
...
static uint32_t _State__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_path_following_interfaces__msg__State(
  ...
  size_t current_alignment)
{
  ...
  // member: position
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_path_following_interfaces__msg__Position(
  ...
  // member: velocity
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_path_following_interfaces__msg__Velocity(
        full_bounded, current_alignment);
    }
  }
  // member: time
...
{
  return max_serialized_size_path_following_interfaces__msg__State(
    full_bounded, 0);
}
