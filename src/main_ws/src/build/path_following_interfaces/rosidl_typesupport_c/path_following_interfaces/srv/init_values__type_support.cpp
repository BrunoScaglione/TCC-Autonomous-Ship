...
static const _InitValues_Request_type_support_symbol_names_t _InitValues_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, path_following_interfaces, srv, InitValues_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, path_following_interfaces, srv, InitValues_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, path_following_interfaces, srv, InitValues_Request)() {
  return &::path_following_interfaces::srv::rosidl_typesupport_c::InitValues_Request_message_type_support_handle;
}
...
static const _InitValues_Response_type_support_symbol_names_t _InitValues_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, path_following_interfaces, srv, InitValues_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, path_following_interfaces, srv, InitValues_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_path_following_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, path_following_interfaces, srv, InitValues_Response)() {
  return &::path_following_interfaces::srv::rosidl_typesupport_c::InitValues_Response_message_type_support_handle;
}
...
static const _InitValues_type_support_symbol_names_t _InitValues_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, path_following_interfaces, srv, InitValues)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, path_following_interfaces, srv, InitValues)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, path_following_interfaces, srv, InitValues)() {
  return &::path_following_interfaces::srv::rosidl_typesupport_c::InitValues_service_type_support_handle;
}
