...
#include "path_following_interfaces/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const path_following_interfaces::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<path_following_interfaces::msg::Position *>(
    untyped_ros_message);
...
{
  return &path_following_interfaces::msg::typesupport_fastrtps_cpp::_Position__handle;
}
