...
#include "path_following_interfaces/msg/detail/state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const path_following_interfaces::msg::Position &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  path_following_interfaces::msg::Position &);
...
{
bool cdr_serialize(
  const path_following_interfaces::msg::Velocity &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const path_following_interfaces::msg::State & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  path_following_interfaces::msg::State & ros_message)
{
  // Member: position
  ...
  size_t current_alignment)
{
  ...
  // Member: position
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        path_following_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Position(
  ...
  // Member: velocity
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        path_following_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Velocity(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const path_following_interfaces::msg::State *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<path_following_interfaces::msg::State *>(
    untyped_ros_message);
...
{
  return &path_following_interfaces::msg::typesupport_fastrtps_cpp::_State__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, path_following_interfaces, msg, State)() {
  return &path_following_interfaces::msg::typesupport_fastrtps_cpp::_State__handle;
}
