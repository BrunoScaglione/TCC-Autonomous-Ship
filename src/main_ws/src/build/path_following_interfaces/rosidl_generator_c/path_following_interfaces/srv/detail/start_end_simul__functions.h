...
#ifndef PATH_FOLLOWING_INTERFACES__SRV__DETAIL__START_END_SIMUL__FUNCTIONS_H_
#define PATH_FOLLOWING_INTERFACES__SRV__DETAIL__START_END_SIMUL__FUNCTIONS_H_
...
/// Initialize srv/StartEndSimul message.
/**
...
/// Finalize srv/StartEndSimul message.
/**
...
/// Create srv/StartEndSimul message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * path_following_interfaces__srv__StartEndSimul_Request__init().
...
/// Destroy srv/StartEndSimul message.
/**
 * It calls
 * path_following_interfaces__srv__StartEndSimul_Request__fini()
...
/// Initialize array of srv/StartEndSimul messages.
/**
...
/// Finalize array of srv/StartEndSimul messages.
/**
 * It calls
 * path_following_interfaces__srv__StartEndSimul_Request__fini()
...
/// Create array of srv/StartEndSimul messages.
/**
 * It allocates the memory for the array and calls
 * path_following_interfaces__srv__StartEndSimul_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/StartEndSimul messages.
/**
 * It calls
 * path_following_interfaces__srv__StartEndSimul_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * path_following_interfaces__srv__StartEndSimul_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_path_following_interfaces
...
/**
 * It calls
 * path_following_interfaces__srv__StartEndSimul_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_path_following_interfaces
...
/**
 * It allocates the memory for the array and calls
 * path_following_interfaces__srv__StartEndSimul_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_path_following_interfaces
...
/**
 * It calls
 * path_following_interfaces__srv__StartEndSimul_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PATH_FOLLOWING_INTERFACES__SRV__DETAIL__START_END_SIMUL__FUNCTIONS_H_
