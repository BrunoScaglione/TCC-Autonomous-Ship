...
bool path_following_interfaces__msg__positions_xy__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("path_following_interfaces.msg._positions_xy.PositionsXY", full_classname_dest, 55) == 0);
  }
  path_following_interfaces__msg__PositionsXY * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of PositionsXY */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("path_following_interfaces.msg._positions_xy");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PositionsXY");
