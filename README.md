...
- **/** &#8594; root directory:
    ...
    - **project_requirements.txt** &#8594; explanation;
...
## Logs, plots and data
        After running a simulation using a package, go to the package's installation annd enter the *share* folder. There you will find generated logs, data and eventually generated plots, of the last simulation. Below, the folders that contain these files are presented for each package.
...
- **/** &#8594; *path_following* installation *share* directory:
    ...
    - **/plots** &#8594; conntains generated plots;
