...
- **/** &#8594; root directory:
    - **/helpers** &#8594; contains complementary files:
        - **/helpers/payloads** &#8594; contains json payloads to be used with the project's HTTP API:
            - **comments.md** &#8594; commments on the payloads;
        ...
        - **client.bat** &#8594; sends initial condition, waypoints and starts simulation through curl http requests and payloads in /helpers/payloads;
        - **configpublic.bat** &#8594; configuration file to use the scripts in this folder;
        - **overlay.bat** &#8594; batch script that sources the workspace;
        - **path.bat** &#8594; batch script that runs the path_following package;
        - **pydyna.bat** &#8594;  batch script that runs the pydyna_simmple package;
    ...
    - **/notes** &#8594; contains useful notes on pydyna or ros2:
        ...
        - **/notes/ros2_notes** &#8594; our notes on some ros2 commands;
    - **/readme_resources** &#8594; contains static files used in README.md;        
    - **/reports** &#8594; contains documents that explain the project, and developed for the obtention of our Mechatronics Engineering degree:
        - **monograph.pdf** &#8594; monograph in ABNT like format (has some diffferences);
    ...
    - **/src** &#8594; contains project code:
        ...
        - **/src/main_ws** &#8594; *ROS2* worskpace:
            ...
            - **/src/main_ws/src** &#8594; source code of the ROS2 packages;
                ...
                - **/src/main_ws/src/pydyna_simple** &#8594; *pydyna_simple* package : ship dynamical system, that subscribes to rudder angle and propeller rotation and publishes the state of the ship;
